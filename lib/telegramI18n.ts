...
const ru = {
  ...
  'order.restLines': 'Остальные строки ({n}) не обработаны — отправьте их заново после уточнения выше.',
...
const uz: Record<MessageKey, string> = {
  ...
  'order.restLines': "Qolgan qatorlar ({n}) qayta ishlanmadi — yuqoridagi tanlovdan keyin ularni qaytadan yuboring.",
